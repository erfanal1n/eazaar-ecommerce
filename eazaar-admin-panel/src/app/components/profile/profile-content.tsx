    ...
    if (user?._id && formData) {
      const res = await updateProfile({
        ...
        data: {
          ...
          // Role is not included - users cannot change their own role
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-1 gap-5">
                ...
                <div className="mb-5">
                  ...
                  <input
                    className="input w-full h-[49px] rounded-md border border-gray6 px-6 text-base text-gray-500 bg-gray-100"
                    type="text"
                    value={user?.role || ""}
                    disabled
                    readOnly
                  />
                  <p className="text-sm text-gray-500 mt-1">Role cannot be modified from profile. Contact administrator to change role.</p>
                </div>
              </div>
