...
const ProductTypeImgUpload = ({ setImage, isSubmitted, default_img, image, setIsSubmitted }: IPropType) => {
  ...
  return (
    <div className="mb-6">
      <p className="mb-2 text-base text-black">Upload Icon</p>
...
export default ProductTypeImgUpload;