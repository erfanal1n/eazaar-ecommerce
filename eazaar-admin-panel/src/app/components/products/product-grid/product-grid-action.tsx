...
const ProductGridAction = ({ id, currentQuantity = 0 }: { id: string; currentQuantity?: number }) => {
      ...
      <div className="flex flex-col items-center justify-start space-y-3 py-2">
        <div className="relative">
          <button
            ...
            className="w-9 h-9 leading-9 text-tiny bg-blue-500 text-white rounded-md hover:bg-blue-600 shadow-sm"
        ...
        <div className="relative">
          <Link href={`/edit-product/${id}`}>
            <button
              ...
              className="w-9 h-9 leading-9 text-tiny bg-success text-white rounded-md hover:bg-green-600 shadow-sm"
            >
              <Edit />
            </button>
          </Link>
        ...
        <div className="relative">
          <button
            ...
            className="w-9 h-9 leading-[30px] text-tiny bg-white border border-gray text-slate-600 rounded-md hover:bg-danger hover:border-danger hover:text-white shadow-sm"
          >
            <Delete />
          </button>
