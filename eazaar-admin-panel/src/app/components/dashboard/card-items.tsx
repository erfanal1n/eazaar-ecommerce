...
function CardItem({ title, amount, cash, card, icon, clr, clr2 }: IPropType) {
  return (
    <div className="widget-item bg-white dark:bg-slate-800 p-6 flex justify-between rounded-md transition-colors duration-300">
      <div>
        <h4 className="text-xl font-semibold text-slate-700 dark:text-white mb-1 leading-none">
          {amount && amount.toFixed(2)}
        </h4>
        <p className="text-tiny leading-4 dark:text-slate-300">{title}</p>
