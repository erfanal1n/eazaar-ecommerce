  ...
  return (
    <div ref={nRef}>
      <button
        ...
        className="relative w-[40px] h-[40px] leading-[40px] rounded-md text-gray dark:text-slate-300 border border-gray dark:border-slate-600 hover:bg-themeLight hover:text-theme hover:border-themeLight dark:hover:bg-slate-700 transition-colors duration-300"
      >
        <Notification />
      ...
      {notificationOpen && (
        <div className="absolute w-[280px] sm:w-[350px] h-auto top-full -right-[60px] sm:right-0 shadow-lg rounded-md bg-white dark:bg-slate-800 py-5 px-5 border dark:border-slate-700 transition-colors duration-300">
          {products &&
            products.slice(0,5).map((item) => (
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  <div className="">
                    <h5 className="text-base mb-0 leading-none dark:text-white">
                      {item.title}
                    </h5>
                    <div className="flex items-center mt-2">
                      ...
                      <span className="text-tiny leading-none dark:text-slate-400">
                ...
                <div className="">
                  <button className="hover:text-danger dark:text-slate-400 dark:hover:text-red-400">
                    <Close />
                  </button>
                </div>
              </div>
