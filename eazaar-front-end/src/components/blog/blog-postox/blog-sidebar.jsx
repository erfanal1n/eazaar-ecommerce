          ...
          <div className="tp-sidebar-widget-content">
            <div className="tp-sidebar-about">
              ...
              <div className="tp-sidebar-about-content">
                ...
                <span className="tp-sidebar-about-designation">Full Stack Developer</span>
                <p>Passionate full stack developer with expertise in modern web technologies. I create scalable applications using React, Node.js, and cutting-edge frameworks to deliver exceptional user experiences.</p>
